...
FS <- read.table("stats1-datafiles-Stats1.13.Lab.06.txt", header = T)
...
# BUT they have more years on the job and more publications, on average, than the other departments, 
# so their PREDICTED salary, based on an AVERAGE number of years and publications is lower, 
# which is a more accuracte reflection of the discrepancies across departments.
