...
wm = read.table("stats1-datafiles-Stats1.13.Lab.11.txt", header = T)
...
# Pooled SD = Weighting SD^2 according to degrees of freedom
pooled.sd = sqrt((79/118 * (wm.t.out[4,4])^2) + (39/118 * (wm.c.out[4,4])^2))
