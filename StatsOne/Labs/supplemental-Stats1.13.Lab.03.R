...
# More detailed correlation information
cor.test(concussed$memory.impair, concussed$ic1)

# Scatterplots 
# Note: Scatterplot functions are available in many packages and 
# offer an array of advanced features. For the sake of time, 
# I will demonstrate just a few examples here. 
# I encourage you to explore beyond these functions and options.
